...
export default function Navbar() {
  return (
    <div className=" lg:relative lg:flex flex-row lg:flex-col justify-between  absolute left-0 hidden dark:text-white bg-white dark:bg-neutral-800 lg:min-w-[100px] min-w-full min-h-[100px] lg:min-h-full">
