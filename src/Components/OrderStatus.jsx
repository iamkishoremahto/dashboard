...
export default function OrderStatus({ status, title, count, percentage, icon, bg_icon_color, icon_color }){
    ...
    return <>
    <div className=" shadow-md rounded-lg md:h-[200px] md:w-[300px] lg:h-[200px] lg:w-[200px]  h-[200px] w-full flex flex-col justify-between dark:bg-neutral-800 bg-indigo-50 ">
